...
//    PaintObject j = new Oval(Color.BLACK, new Point2D(500, 20), new Point2D(600, 220));
//    // Make an oval that is wider than higher. First Point2D is still upper left
//    PaintObject k = new Oval(Color.GREEN, new Point2D(500, 220), new Point2D(680, 230));
//    // First Point2D(800, 250) is below and to the right of the second Point2D for a circle
//    PaintObject l = new Oval(Color.RED, new Point2D(760, 320), new Point2D(660, 220));
//    // Another circle with upper left to the other side
//    PaintObject m = new Oval(Color.BLUE, new Point2D(600, 350), new Point2D(700, 400));
...
//    PaintObject o = new Picture(new Point2D(220, 280), new Point2D(140, 140), "doge.jpeg");
//    PaintObject p = new Picture(new Point2D(500, 320), new Point2D(700, 460), "doge.jpeg");
//    PaintObject q = new Picture(new Point2D(300, 20), new Point2D(300, 360), "doge.jpeg");
//    allPaintObjects.add(n);
//    allPaintObjects.add(o);
//    allPaintObjects.add(p);
//    allPaintObjects.add(q);
